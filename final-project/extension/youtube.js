...
// Wrap everything in an IIFE (private bubble) to prevent variable collisions
(function() {
  ...
  // Expose ONLY initYouTube to the global window object so content.js can access it
